  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Enterprise signal colors
        signal: {
          nominal: "hsl(var(--signal-nominal))",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { opacity: "1", boxShadow: "0 0 8px hsl(var(--signal-nominal) / 0.6)" },
          "50%": { opacity: "0.7", boxShadow: "0 0 16px hsl(var(--signal-nominal) / 0.4)" },
        },
        "shimmer": {
